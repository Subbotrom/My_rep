...
def grafic_perm():
        ...
        plt.scatter(lenth, (np.array(lenth)*(np.array(lenth)-1))/2, c="orange", s=5, label="Пузырёк")
        plt.scatter(lenth, perm_3, c="green", s=5, label="Сортировка Шелла (шаг х 0.5)")
        plt.scatter(lenth, perm_2, c="red", s=5, label="Сортировка Шелла (шаг х 0.8)")
        plt.scatter(lenth, perm_1, c="blue", s=5, label="Сортировка Шелла Хиббард") 
